...
String Payload ="{",  Payload2 ="{";      // Chaine de caractère qui contiendra le message envoyer de l'objet vers thingsboard
...
void appendPayloadStr(String Name, String Val)
{
...
void sendPayloadStr()
{
  char attributes[200];
  Payload2 += "}";
  Payload2.toCharArray(attributes, 200);
  ClientMQTT.publish("v1/devices/me/telemetry", attributes);
  
  Serial.print("Payload2 -> ");
  Serial.println(Payload2);
  Serial.print("Payload2 length -> ");
